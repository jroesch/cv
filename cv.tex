...
\usepackage[sorting=ddatent, style=numeric, maxbibnames=99]{biblatex}
...
\address{OctoML, 1000 N Northlake Way}{98103 Seattle, WA}{USA} % optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\email{jroesch@octoml.ai}                               % optional, remove / comment the line if not wanted
...
\section{Education}
\cventry{2015--2020}{PhD}{University of Washington}{Seattle, WA}{}{}
...
\cventry{July 2019 - Present}{CTO \& Co-founder}{OctoML}{}{}{
  OctoML is building the systems layer to turn foundational models into complete products which act as next generation AI infrastructure. Raised over 130M+ in Venture Capital. Employ numerous UW CSE Alumni.
  Leading both research for our products in conjunction with Tianqi Chen, and directly oversaw product development for the last year.
  \newline{}}
